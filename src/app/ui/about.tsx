				...
				<WhatIdo>
					...
					<details>
						...
						<p className={`${calibre.className}`}>
							I shape the web with art and logic, Creating front end applications that are dynamic
							and ergonomic. I design, build, test and maintain with care and precision, Ensuring
